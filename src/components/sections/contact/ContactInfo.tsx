      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
        ...
        <div className="space-y-6">
          <div className="flex items-center space-x-4 p-4 bg-white rounded-lg shadow-sm hover:shadow-md transition-shadow">
            ...
            <div>
              ...
              <p className="text-base text-foregroundLight">
                <Link
        ...
        <div className="space-y-6">
          <div className="p-4 bg-white rounded-lg shadow-sm hover:shadow-md transition-shadow">
            <h3 className="text-xl font-semibold text-foreground flex items-center space-x-2 mb-2">
              <span>Follow Us</span>
            </h3>
            <p className="text-base text-foregroundLight mb-4">
